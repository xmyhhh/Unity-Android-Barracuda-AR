...
public class HeadsetStationaryDetectEventController : MonoBehaviour
{
    ...
    public void OnHeadsetStationaryDetect(SensorDataAccuracy accuracy)
    {
        CancelInvoke("ResetSensorText");
        sensorValue.text = "Headset Stationary Detect";
