...
[CustomEditor(typeof(ImageSourceSelector))]
sealed class ImageSourceSelectorEditor : Editor
{
    static class Labels
    {
        ...
        public static Label MoverioTexture = "Render Texture";
        public static Label Flip = "Flip";
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        var type = (ImageSourceSelector.SourceType)_sourceType.Target.enumValueIndex;

        if (type == ImageSourceSelector.SourceType.Texture)
        {
        ...
        if (type == ImageSourceSelector.SourceType.Video)
        {
        ...
        if (type == ImageSourceSelector.SourceType.Webcam)
        {
        ...
        if (type == ImageSourceSelector.SourceType.MoverioCam)
        {

            EditorGUILayout.PropertyField(moverioTexture, Labels.MoverioTexture);
            EditorGUILayout.PropertyField(flip, Labels.Flip);
