...
public class DataProcess
{
    ...
    private BoundingBoxDimensions[] NMS(BoundingBoxDimensions[] rects, float[] prob, float threshold = 0.3f)
    {
        var rect_ranges = new List<BoundingBoxDimensions>(rects);
        var rect_result = new List<BoundingBoxDimensions>();
    ...
    private List<double> Get_iou(BoundingBoxDimensions[] rects, BoundingBoxDimensions box)
    {
